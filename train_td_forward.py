...
from agents.td_lambda_forward import TD_Lambda
...
# agent
agent = TD_Lambda(num_states= NUM_STATES,alpha= 0.1, discount_factor= 0.95,epsilon=0.2, num_actions= NUM_ACTIONS, epsilon_mode="constant",
                    alpha_mode="constant")
